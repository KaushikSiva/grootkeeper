...
2. Show the Isaac scene objects and explain that perception is coming from the simulated world state first.
...
5. Show Isaac Sim receiving the action and executing the task.
